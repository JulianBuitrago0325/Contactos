...
import 'dart:async';
import 'package:contactos/ui/contactos_information.dart';
import 'package:contactos/ui/contactos_screen.dart';
            ...
            itemBuilder: (context,position){
               return Column(
                 children: <Widget>[
                   ...
                   Row(
                     children: <Widget>[
                       Expanded(child: ListTile(title: Text('${items[position].nombre} '+'${items[position].apellido}',
                        style: TextStyle(
                         ...
                         leading: Column(
                           children: <Widget>[
                             CircleAvatar(
                               ...
                               radius: 17.0,
                               child: Text('${items[position].tipoSangre}',
                                 style: TextStyle(
                                   color: Colors.blueGrey,
                                   fontSize: 21.0
                                 ),
